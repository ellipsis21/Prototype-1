...
(function() {
  ...
  function connect_to_chat_firebase(){
    ...
    display_msg({m:"Share this url with your friend to join this chat: "+ document.location.origin+"/#"+fb_chat_room_id + "<br>This chat is enable with video emojis! <br>When you enter any of these: lol, :), :(, :/, haha, :p, rofl, :-), :-(, :o a video of you will be added to the chat. <br>Press enter with no text to just send a video of your last three seconds!<br>Wait five seconds with the webcam on for the videos to start being sent.",c:"red"})
  ...
  function display_msg(data){
	...
	video = null;
	  ...
	  //window.setTimeout(function(){document.getElementById("conversation").removeChild(video)},6000);
    }
  }
